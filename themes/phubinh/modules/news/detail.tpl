...
<div class="news_column wow fadeInUp" itemtype="http://schema.org/NewsArticle" itemscope>
    <div class="bg-detail-news clearfix mar-15">
        <div class="col-xs-24 col-sm-24 col-md-18">
            ...
            <figure class="article center">
                <img alt="{DETAIL.image.alt}" src="{DETAIL.image.src}" srcset="{DETAIL.srcset}" class="img-detail-news" style="width: 100%" />
                <!-- BEGIN: note --><figcaption>{DETAIL.image.note}</figcaption><!-- END: note -->
            </figure>
            <!-- END: imgfull -->
            <div class="news-publtime"><i aria-hidden="true" class="ic-elegant icon_calendar"> </i> {DETAIL.publtime}</div>
            <h1 class="title-detail-news" itemprop="headline">{DETAIL.title}</h1>
            <div class="clearfix">
                <!-- BEGIN: imgthumb -->
                <!-- BEGIN: note -->
        ...
        <div class="col-xs-24 col-sm-24 col-md-6">[RIGHT]</div>
    </div>
</div>

<!-- BEGIN: keywords -->
<div class="news_column box-viewcatpage">
    <div class="">
        <div class="h5">
...
<!-- BEGIN: comment -->
<div class="news_column box-commentpage">
    <div class="">
        {CONTENT_COMMENT}
    </div>
</div>
...
<!-- BEGIN: others -->
<div class="news_column box-viewcatpage" style="margin-bottom: 0">
    <div class="other-news">
        <!-- BEGIN: topic -->
        <h3 class="h3-other-news">{LANG.topic}</h3>
        <div class="other-col clearfix">
        ...
        <!-- BEGIN: related_new -->
        <h3 class="h3-other-news">{LANG.related_new}</h3>
        <div class="other-col clearfix">
            <ul class="detail-related related list-none list-items">
                <!-- BEGIN: loop -->
                <li>
        ...
        <!-- BEGIN: related -->
        <h3 class="h3-other-news">{LANG.related}</h3>
        <div class="other-col clearfix">
            <ul class="detail-related related list-none list-items">
                <!-- BEGIN: loop -->
                <li>
