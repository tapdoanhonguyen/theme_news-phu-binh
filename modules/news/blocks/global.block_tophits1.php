...
if (!nv_function_exists('nv_news_block_tophits1')) {
    /**
     * nv_block_config_tophits1_blocks()
     *
     * @param mixed $module
    ...
    /**
     * nv_block_config_tophits1_blocks_submit()
     *
     * @param mixed $module
     * @param mixed $lang_block
     * @return
    ...
    function nv_news_block_tophits1($block_config, $mod_data)
    {
        ...
        if (file_exists(NV_ROOTDIR . '/themes/' . $global_config['module_theme'] . '/modules/' . $mod_file . '/block_tophits1.tpl')) {
            $block_theme = $global_config['module_theme'];
        } else {
            $block_theme = 'default';
        }

        $xtpl = new XTemplate('block_tophits1.tpl', NV_ROOTDIR . '/themes/' . $block_theme . '/modules/' . $mod_file);
