...
<div class="page wow bg-detail-news fadeInUp" itemtype="http://schema.org/Article" itemscope>
    <div class="">
        <h1 class="title-page title-detail-news" itemprop="headline">{CONTENT.title}</h1>
