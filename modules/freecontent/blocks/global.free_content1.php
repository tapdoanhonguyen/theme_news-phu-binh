...
if (!nv_function_exists('nv_block_freecontent1')) {
    /**
     * nv_block_config_freecontent1()
     *
     * @param string $module
     ...
     * @return string
     */
    function nv_block_config_freecontent1($module, $data_block, $lang_block)
    {
    ...
    /**
     * nv_block_config_freecontent1_submit()
     *
     * @param string $module
     * @param array  $lang_block
     * @return array
     */
    function nv_block_config_freecontent1_submit($module, $lang_block)
    {
        global $nv_Request;
        $return = [];
        $return['error'] = [];
    ...
    /**
     * nv_block_freecontent1()
     *
     * @param array $block_config
     * @return string
     * @throws PDOException
     */
    function nv_block_freecontent1($block_config)
    {
        ...
        if (!empty($list)) {
            if (file_exists(NV_ROOTDIR . '/themes/' . $global_config['module_theme'] . '/modules/' . $site_mods[$module]['module_file'] . '/block.free_content1.tpl')) {
                $block_theme = $global_config['module_theme'];
            } elseif (file_exists(NV_ROOTDIR . '/themes/' . $global_config['site_theme'] . '/modules/' . $site_mods[$module]['module_file'] . '/block.free_content1.tpl')) {
                $block_theme = $global_config['site_theme'];
            } else {
                $block_theme = 'default';
            }

            $xtpl = new XTemplate('block.free_content1.tpl', NV_ROOTDIR . '/themes/' . $block_theme . '/modules/' . $site_mods[$module]['module_file']);
...
if (defined('NV_SYSTEM')) {
    $content = nv_block_freecontent1($block_config);
}
