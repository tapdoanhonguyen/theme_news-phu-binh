...
if (!nv_function_exists('nv_news_category')) {
    ...
    {
        global $module_array_cat, $lang_module, $module, $site_mods, $global_config;
...
if (defined('NV_SYSTEM')) {
    ...
    if (isset($site_mods[$module])) {
        if ($module == $module_name) {
            ...
            $module_array_cat = [];
            $sql = 'SELECT catid, parentid, title, alias, viewcat, image, subcatid, numlinks, description, descriptionhtml, keywords, groups_view, status FROM ' . NV_PREFIXLANG . '_' . $site_mods[$module]['module_data'] . '_cat ORDER BY sort ASC';
