...
function viewcat_page_new($array_catpage, $array_cat_other, $generate_page)
{
    ...
    foreach ($array_catpage as $array_row_i) {
        $newday = $array_row_i['publtime'] + (86400 * $array_row_i['newday']);
        $array_row_i['publtimed'] = nv_date('d', $array_row_i['publtime']);
        $array_row_i['publtimem'] = nv_date('m', $array_row_i['publtime']);
        $array_row_i['publtimey'] = nv_date('Y', $array_row_i['publtime']);
        $array_row_i['listcatid'] = explode(',', $array_row_i['listcatid']);
        $array_row_i['cattitle'] = $global_array_cat[$catid]['title'];
...
{
    global $global_config, $module_info, $module_array_cat, $lang_module, $module_name, $module_config, $lang_global, $client_info;
