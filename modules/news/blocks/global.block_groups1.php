...
if (! nv_function_exists('nv_block_news_groups1')) {
    /**
     * nv_block_config_news_groups1()
     *
     * @param mixed $module
     ...
     * @return
     */
    function nv_block_config_news_groups1($module, $data_block, $lang_block)
    {
    ...
    /**
     * nv_block_config_news_groups1_submit()
     *
     * @param mixed $module
     * @param mixed $lang_block
     * @return
     */
    function nv_block_config_news_groups1_submit($module, $lang_block)
    {
        global $nv_Request;
        $return = array();
        $return['error'] = array();
    ...
    /**
     * nv_block_news_groups1()
     *
     * @param mixed $block_config
     * @return
     */
    function nv_block_news_groups1($block_config)
    {
...
if (defined('NV_SYSTEM')) {
    ...
    if (isset($site_mods[$module])) {
        ...
        $content = nv_block_news_groups1($block_config);
    }
}
