...
if (! nv_function_exists('nv_contact_default_info1')) {
    function nv_contact_default_info1($module)
    {
        global $nv_Cache, $site_mods, $global_config, $lang_global;
        if (isset($site_mods[$module])) {
            if (file_exists(NV_ROOTDIR . '/themes/' . $global_config['module_theme'] . '/modules/' . $site_mods[$module]['module_file'] . '/block.contact_default1.tpl')) {
                $block_theme = $global_config['module_theme'];
            } elseif (file_exists(NV_ROOTDIR . '/themes/' . $global_config['site_theme'] . '/modules/' . $site_mods[$module]['module_file'] . '/block.contact_default1.tpl')) {
            ...
            $xtpl = new XTemplate('block.contact_default1.tpl', NV_ROOTDIR . '/themes/' . $block_theme . '/modules/' . $site_mods[$module]['module_file']);
...
if (defined('NV_SYSTEM')) {
    $content = nv_contact_default_info1($block_config['module']);
}